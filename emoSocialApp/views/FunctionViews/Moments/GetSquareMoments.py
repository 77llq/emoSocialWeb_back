...
from emoSocialApp.models import UserProfile, User, FriendsRequest, Moments, MomentsComment, MomentsLike


class GetSquareMomentsView(ModelViewSet):
    permission_classes = []

    def list(self, request, *args, **kwargs):
        momentsInfo = []
        # 从数据库中按照 postTime 的倒序获取所有动态
        allMoments = Moments.objects.all().order_by('-postTime')
